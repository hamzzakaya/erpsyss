  ...
  const handleChange = (e) => {
    ...
    setFormData(prev => {
        ...
        if (name === "producedQuantity" || name === "scrap") {
            const producedQuantity = parseInt(newFormData.producedQuantity, 10) || 0;
  ...
  return (
    <div className="p-5">
      ...
      <div className="mt-8">
        ...
        <ul>
          {productList.map((product, index) => (
            <li key={index} className="mb-2 p-2 shadow rounded bg-white">
              ...
              Durumu: {product.productStatus}, Bölüm: {formatDepartment(product.department)}
              <button onClick={() => handleRemoveProduct(index)} className="ml-4 bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded">
                ×
              </button>
        ...
        <button onClick={handleProductsSave} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
    Kaydet
</button>
